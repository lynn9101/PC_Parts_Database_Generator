<?php include('partials-frontend/header.php'); ?>
    ...
    <section class="product-main-content">
        ...
        <form action="http://localhost/pc_parts_database_generator/user/PSUPage.php" method="POST">
            <div class="filter">
                <h3>Colour</h3>
            </div>
        ...
        <div class="results-section">
            <table>
                ...
                <?php
                    ...
                    // Query to get all suppliers in the database
                    $sql = "SELECT p1.modelname model, p1.watts watts, p1.modularity, p2.colour color 
                    FROM powersupply1 p1
                    INNER JOIN powersupply2 p2 
